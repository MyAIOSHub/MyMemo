export const bnIN = {
  common: {
    ...
    writeNote: "নোট লিখুন",
    works: "কাজ",
    noWorksYet: "এখনো কোনো কাজ নেই",
    noWorksDesc: "স্টুডিওতে কন্টেন্ট তৈরি করলে এখানে দেখা যাবে",
    filterAll: "সব",
    filterSources: "সোর্স",
    filterMemories: "স্মৃতি",
    filterNotes: "নোট",
    batchMode: "ব্যাচ মোড",
    optional: "ঐচ্ছিক",
    type: "ধরন",
  ...
  studio: {
    ...
    generationComplete: "তৈরি সম্পন্ন",
    generationFailed: "তৈরি ব্যর্থ",
    selectModel: "প্রথমে একটি মডেল কনফিগার করুন",

...
3. **Update regularly** — Pull latest image: `docker pull myaioshub/mymemo:latest`
...
- **Ask for help:** [Discord](https://discord.gg/37XJPXfz2w) or [GitHub Issues](https://github.com/MyAIOSHub/MyMemo/issues)
